    ...
    <>
      ...
      <div className="flex flex-wrap justify-center bg-[#fafbfc] space-x-8 h-auto mt-8 py-8">
        ...
        <div className="lg:w-[50vw] ss:w-full space-y-16">
          <div id="mission" className="ss:mt-8 md:mt-0">
            ...
            <p className="md:text-[34px] ss:text-[24px] mt-4 font-bold">
              Our Mission
            </p>
      ...
      <div className="flex flex-wrap">
        <div className="lg:flex-1 px-8">
          <p className="font-bold md:text-[34px] ss:text-[24px] ss:text-[20px] my-8 break-normal">
            HSE Policy
          </p>
        ...
        <div className="lg:flex-1 px-8">
          <p className="font-bold md:text-[34px] ss:text-[24px] ss:text-[20px] my-8 break-normal text-center">
