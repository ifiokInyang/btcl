	...
	return (
		<div className="">
			...
			<div className="flex justify-center items-center flex-wrap py-8 w-full h-auto">
				...
				<div
					className="h-[600px] md:w-[400px] ss:w-[300px] rounded-lg order-2"
					...
					<div className="flex flex-col justify-around h-[450px]">
						<div className="flex ss:px-0 md:px-8">
							...
							<div>
								...
								<p className="font-medium text-red-500">Office</p>

								<p className="font-medium">
									15 Saint Andrew’s Street, Rumuobiakani, Port Harcourt, Rivers
									State, Nigeria
								</p>
								<p className="font-medium text-red-500 pt-4">Operation Yard</p>
								<p className="font-medium">
						...
						<div className="flex ss:px-0 md:px-8">
							...
							<div>
								...
								<p className="font-medium">+234 803 336 5111</p>
								<p className="font-medium">+234 705 742 4183</p>
							</div>
						</div>
						<div className="flex ss:px-0 md:px-8">
							<div className="mr-4">
							...
							<div>
								...
								<p className="font-medium">info@bensmartech.com</p>
							</div>
						</div>
					</div>
				</div>
				<div className="md:order-3 ss:order-1">
					...
					<iframe
						src="https://www.google.com/maps/embed?pb=!1m16!1m12!1m3!1d63611.23550680354!2d6.977439892084724!3d4.821104887016162!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!2m1!1s15%20Saint%20Andrew%E2%80%99s%20Street%2C%20Rumuobiakani%2C%20Port%20Harcourt%2C%20Rivers%20State%2C%20Nigeria!5e0!3m2!1sen!2sng!4v1698512332201!5m2!1sen!2sng"
						width="600"
						height="450"
						style={{ border: "0" }}
